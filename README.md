...
**Project**: rescue-aid-navigator 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: I would like to construct a first responder app that calls emergency services giving full details needed. Until the need arrives, best practice aid should be provided  
...
```sh
git clone https://github.com/GPT-Engineer-App/rescue-aid-navigator.git
cd rescue-aid-navigator
npm i
